                ...
                <div class="list_of_menu">
                    ...
                    <ul class="alt">
                        ...
                        <?php 
                            ...
                            $q = " select menu.menu from menu where menu.splittable = TRUE and menu.mid in (select offers.mid from offers where offers.rid = $rest);";
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                            ...
                            <input type="button" name = "pay" value="Payment" class="button" <?php if(!isset($_POST['Menu'])) { echo 'disabled = "disabled"';}
                                   ?>
                                    onClick="Javascript:window.location.href = 'split_order_create_page3.php';" />
