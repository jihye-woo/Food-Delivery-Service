...
CREATE TABLE ORDERS (
    ...
    PRIMARY KEY (oid),
    FOREIGN KEY (qid) REFERENCES WAITLIST(qid) ON DELETE CASCADE,
...
INSERT INTO LOCATION (location) VALUES ("Dormitory Bldg B ATM");
INSERT INTO LOCATION (location) VALUES ("Parking Lot C");
INSERT INTO LOCATION (location) VALUES ("Academic Building A");
INSERT INTO LOCATION (location) VALUES ("Academic Building B");
INSERT INTO LOCATION (location) VALUES ("CS Commons");
INSERT INTO LOCATION (location) VALUES ("LEAD Lab");
INSERT INTO LOCATION (location) VALUES ("Game Lab");
INSERT INTO LOCATION (location) VALUES ("IGC Guesthouse");
...
INSERT INTO USERS (username, pw, coin, lid) VALUES ("jwoo", "1234", 2000000, 6); # "CS Commons"      # 2
INSERT INTO USERS (username, pw, coin, lid) VALUES ("bkoo", "bKoo123", 200000, 3); # "Parking Lot C"   # 3

# WAITLIST
INSERT INTO WAITLIST (rid, lid, otype) VALUES (1, 3, FALSE);    # "Kimbob Heaven", "Parking Lot C", FALSE
INSERT INTO ORDERS (qid, uid, mid) VALUES (1, 2, 3);
INSERT INTO WAITLIST (rid, lid, otype) VALUES (3, 8, FALSE);     # "Fall in Love With Sushi", "Game Lab", FALSE
INSERT INTO ORDERS (qid, uid, mid) VALUES (2, 1, 11);
