...
<section id = "main">
	<div class="inner">
    <br>
    <h1><br>Split Order Waitlist</h1>
    <br>
		<ul class="actions">
        <li><a href="split_order_create_page.php" class="button alt">Create New Split Order</a></li>
		<br>
		<li>Create a New Split Order if there is no desired menu in the waitlist.
			<br>
...
<!--                         -->
                ...
                <tbody>
                    ...
                    <?php 
                    $waitlists = NULL;
                    $query  = "select qid, rname, location, min_price from WAITLIST Natural Join RESTAURANT Natural Join LOCATION where otype = False;";
